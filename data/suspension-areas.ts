...
export const SUSPENSION_AREAS: SuspensionArea[] = [
  ...
  { id: "coilovers", label: "Coilovers (factory suspension)", ready: false },
  ...
  { id: "partial-front", label: "Partial Front Systems", ready: false },
  { id: "full-front", label: "Full Front Systems", ready: false },
  { id: "mustang-ii", label: "Mustang II Systems", ready: true },
];
